...
(function () {
    //百度地图服务器地址
    var BAIDUMAP_SERVER_DOMAIN = "//10.30.17.68/map/";
    ...
    var qa = window.BMap_loadScriptTime, ra = (new Date).getTime(), sa = p, ua = o, va = p, wa = 5042, xa = 5002, ya = 5003, za = "load_mapclick", Aa = 5038, Ba = 5041, Ca = 5047, Da = 5036, Fa = 5039, Ga = 5037, Ha = 5040, Ia = 5011, Ja = 7E3;
    ...
    x.extend(Ka.prototype, {
        ta: function () {
            ...
            var b = a || {}, a = b.margins || [0, 0, 0, 0], c = b.zoom || p, b = this.zb({
                x: a[3],
                y: this.height - a[2]
            }, c), a = this.zb({x: this.width - a[1], y: a[0]}, c);
            return new eb(b, a)
        }, Hx: function () {
            return !!this.loaded
        }, DR: function (a, b) {
    ...
    "2" !== z.ou && (function (a, b, c) {
        (function (a, b, c) {
            ...
            var B = c.alog;
            if (!B || !B.Ho) {
                var A = b.all && a.attachEvent, D = B && B.sE || +new Date, C = a.T2 || (+new Date).toString(36) + Math.random().toString(36).substr(2, 3), E = 0, J = {}, O = function (a) {
            ...
            if (d.Bd == this.Fj.Zp)c && b(); else {
                if (d.Bd == this.Fj.hG) {
                    ...
                    e.zC == q && (e.zC = o, setTimeout(function () {
                        ...
                        e.Md.En.length = 0;
                        if (a.length > 0) {
                            Pb(BAIDUMAP_SERVER_DOMAIN + "js/getmodules.js");
                        } else {
                            e.LK()
                        }
                    }, 1));
    ...
    x.extend(Cc.prototype, {
        pa: function () {
            ...
            var d = this.map, e = d.va(), f = d.Ha, g = d.wc, i = e.Lc(f), k = this.dL(), l = k[0], m = k[1], n = k[2], u = k[3], v = k[4], c = "undefined" != typeof c ? c : 0, e = e.k.Ob, k = d.ca.replace(/^TANGRAM_/, "");
            ...
            var a = this.map, b = a.va(), c = b.XD(a.Ha), d = a.wc, e = Math.ceil(d.lng / c), f = Math.ceil(d.lat / c), b = b.k.Ob, c = [e, f, (d.lng - e * c) / c * b, (d.lat - f * c) / c * b];
            return [c[0] - Math.ceil((a.width / 2 - c[2]) / b), c[1] - Math.ceil((a.height / 2 - c[3]) / b), c[0] + Math.ceil((a.width / 2 + c[2]) / b), c[1] + Math.ceil((a.height / 2 + c[3]) / b), c]
        }, a_: function (a, b, c, d) {
            var e = this;
            e.h1 = b;
            var f = this.map.va(), g = e.SD(a, c), i = f.k.Ob, b = [a[0] * i + b[0], (-1 - a[1]) * i + b[1]], k = this.wg[g];
            ...
            for (var b = this.Km.concat(this.Wf), c = b.length, d = 0; d < c; d++) {
                ...
                if (!e.TH && !(e.mp && !this.map.Ub() || e.$L && this.map.Ub())) {
                    ...
                    var u = m.Lc(i), i = m.XD(i), f = Math.ceil(n.lng / i), g = Math.ceil(n.lat / i), v = m.k.Ob, i = [f, g, (n.lng - f * i) / i * v, (n.lat - g * i) / i * v], k = i[0] - Math.ceil((l.width / 2 - i[2]) / v), f = i[1] - Math.ceil((l.height / 2 - i[3]) / v), g = i[0] + Math.ceil((l.width / 2 + i[2]) / v), w = 0;
                    m === Na && 15 == l.fa() && (w = 1);
                    m = i[1] + Math.ceil((l.height / 2 + i[3]) / v) + w;
                    this.IJ = new H(n.lng, n.lat);
                    var y = this.wg, v = -this.IJ.lng / u, w = this.IJ.lat / u, u = [Math.ceil(v), Math.ceil(w)], n = l.fa(), B;
                    for (B in y) {
                        var A = y[B], D = A.info;
    ...
    Uc.getTilesUrl = function (a, b, c) {
        ...
        return BAIDUMAP_SERVER_DOMAIN + "tiles/" + z + "/" + x + "/" + y + ".png";
    };
    ...
    var $c = 2, ad = 3, cd = 0, dd = "bt", ed = "nav", fd = "walk", gd = "bl", hd = "bsl", id = 14, jd = 15, kd = 18, ld = 20, md = 31;
            ...
            if (!b || !c || !c.lngLat || !c.panoInstance)d(); else {
                ...
                this.fo.aC(b, function (b) {
                    b ? e.fo.qj(c.lngLat, Vd.dP, function (b) {
                        if (b && b.id) {
                            var f = b.id, k = b.vh, b = b.wh, l = ac.Rd.nh(c.lngLat), m = e.SR(l, {
                                x: k,
                                y: b
    ...
    var de = Zd ? "-" + Zd.toLowerCase() + "-" : "", fe = ee("transform"), ge = ee("transitionProperty"), he = ee("transitionDuration"), ie = ee("transformOrigin"), je = ee("transitionTimingFunction"), ke = ee("transitionDelay"), xd = /android/gi.test(navigator.appVersion), ne = /iphone|ipad/gi.test(navigator.appVersion), oe = /hp-tablet/gi.test(navigator.appVersion), pe = ee("perspective")in Yd, qe = "ontouchstart"in window && !oe, re = Zd !== q, se = ee("transition")in Yd, te = "onorientationchange"in window ? "orientationchange" : "resize", ue = qe ? "touchstart" : "mousedown", ve = qe ? "touchmove" : "mousemove", we = qe ? "touchend" : "mouseup", xe = qe ? "touchcancel" : "mouseup", ye = Zd === q ? q : {
        "": "transitionend",
        webkit: "webkitTransitionEnd",
        Moz: "transitionend",
        O: "otransitionend",
        ms: "MSTransitionEnd"
    }[Zd], ze = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (a) {
            return setTimeout(a, 1)
        }, Ae = window.cancelRequestAnimationFrame || window.q4 || window.webkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame || window.oCancelRequestAnimationFrame || window.msCancelRequestAnimationFrame || clearTimeout, Be = pe ? " translateZ(0)" : "";
    ...
    Ce.prototype = {
        ...
        QS: function (a) {
            var b = qe ? a.touches[0] : a, c = b.pageX - this.vh, d = b.pageY - this.wh, e = this.x + c, f = this.y + d, g = a.timeStamp || Date.now();
        ...
        $u: function (a) {
            if (!(qe && 0 !== a.touches.length)) {
                var b = this, c = qe ? a.changedTouches[0] : a, d, e, f = {Aa: 0, time: 0}, g = {
                    Aa: 0,
                    time: 0
    ...
    var Fe = [0, 1, 2, 2, 2, 2, 2, 2, 2, 3, 3, 3, 3, 4, 5, 5, 5, 6, 6, 7, 8, 8, 8, 9, 10], Ge = "\u5176\u4ed6 \u6b63\u95e8 \u623f\u578b \u8bbe\u65bd \u6b63\u95e8 \u9910\u996e\u8bbe\u65bd \u5176\u4ed6\u8bbe\u65bd \u6b63\u95e8 \u8bbe\u65bd \u89c2\u5f71\u5385 \u5176\u4ed6\u8bbe\u65bd".split(" ");
    z.Sm(function (a) {
        var b = p;
